...
from dscrapy.utils.python import isbinarytext

class ResponseTypes(object):

    CLASSES = {
        'text/html': 'dscrapy.http.HtmlResponse',
        'application/atom+xml': 'dscrapy.http.XmlResponse',
        'application/rdf+xml': 'dscrapy.http.XmlResponse',
        'application/rss+xml': 'dscrapy.http.XmlResponse',
        'application/xhtml+xml': 'dscrapy.http.HtmlResponse',
        'application/vnd.wap.xhtml+xml': 'dscrapy.http.HtmlResponse',
        'application/xml': 'dscrapy.http.XmlResponse',
        'application/json': 'dscrapy.http.TextResponse',
        'application/javascript': 'dscrapy.http.TextResponse',
        'application/x-javascript': 'dscrapy.http.TextResponse',
        'text/xml': 'dscrapy.http.XmlResponse',
        'text/*': 'dscrapy.http.TextResponse',
    }
