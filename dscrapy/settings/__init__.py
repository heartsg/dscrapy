...
class DScrapySettings(Settings):

    def __init__(self, settings_module=None, **kw):
        super(DScrapySettings, self).__init__(**kw)
    ...
    def __getitem__(self, opt_name):
        ...
        return super(DScrapySettings, self).__getitem__(opt_name)

    def __str__(self):
        return "<DScrapySettings module=%r>" % self.settings_module
